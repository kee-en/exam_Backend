...
SECRET_KEY = "django-insecure-#gpu&o!!p$1aanmt7tia&4l)e)h4_(sm9knvr+46))9)fktysy"
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("POSTGRES_DB", "examportaldb"),
        "USER": os.getenv("POSTGRES_USER", "dev"),
        "PASSWORD": os.getenv("POSTGRES_PASSWORD", "kien1029"),
